...
# Instalar JavaFX con: configurar_javafx-1.17.0.8.jar 
RUN java -jar /java-17-openjdk/configurar_javafx-1.17.0.8.jar 
RUN chmod -R o+rwx /java-17-openjdk/*
...
WORKDIR /java-17-openjdk

# What the container should run when it is started.
# Entrypoint de shell ... o no shell ["...", "..."]
# ENTRYPOINT java
# Comando sin shell, de prueba
# CMD ["gimp"]
# Comando de shell
CMD java --module-path . --add-modules javafx.controls,javafx.fxml,javafx.web,javafx.media,javafx.graphics,javafx.base,javafx.swing -jar hola_mundo_navegador_web-1.0.jar | tee -a /java-17-openjdk/output/hola_mundo_navegador_web-1.0.txt 
